...
class MarimoIslandStub:
    ...
    def __init__(
        ...
        *,
        ...
        self._last_render_options: tuple[bool, bool, bool] | None = None
    ...
    def to_payload(self) -> MarimoIslandCellPayload:
        """Return the JSON-safe payload for this island cell."""
        (
            resolved_display_code,
            resolved_display_output,
            resolved_is_reactive,
        ) = self._last_render_options or self._resolve_render_options()
        output_html = self._output_html()
        code = (
            self.code if resolved_is_reactive or resolved_display_code else ""
        )
        return {
            ...
            "reactive": resolved_is_reactive,
            "displayCode": resolved_display_code,
            "displayOutput": resolved_display_output,
        }
    ...
    def _output_html(self) -> str | None:
