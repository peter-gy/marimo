...
async def run_futures_cases():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
        ...
        threading.Timer(TIMER_DELAY, cooperative_event.set).start()
    ...
    try:
        ...
        record("futures.future_result_negative_timeout_immediate", "api-compatible")
        ...
        record("futures.future_exception_negative_timeout_immediate", "api-compatible")
        ...
        record("futures.as_completed_negative_timeout_immediate", "api-compatible")
